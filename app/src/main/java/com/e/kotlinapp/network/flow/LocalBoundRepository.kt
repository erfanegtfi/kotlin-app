...
abstract class LocalBoundRepository<RESULT, REQUEST> :BaseRepository(){

    fun asFlow() = flow<ResponseResultWithWrapper<ResponseWrapper<RESULT>>> {
        ...
        try {
            ...
            emit(ResponseResultWithWrapper.Success(ResponseWrapper(data = fetchFromLocal().first())))
